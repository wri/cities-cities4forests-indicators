               ...
               fluidRow(
                 ...
                 column(3,
                        ...
                        selectizeInput(inputId = "indicator",
                                       ...
                                       selected = "Open space for public use", #  "Open space for public use" 
                                       multiple = FALSE,
                                       width = '100%'),
                 ...
                 column(8,
                        ...
                        tabsetPanel(type = "tabs",
                                    ...
                                    tabPanel("Benchmark", plotlyOutput("cities_comparison_plot",
                                                                       height = 500),downloadButton(outputId = "downloadDataBenchmark",
...
server <- function(input, output, session) {
  ...
  observe({
    ...
    print(paste("selected_indicator_legend: ", selected_indicator_legend))
